...
<main className="container mx-auto px-2 sm:px-4 md:px-8 py-8 sm:py-12">
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6">Settings</h1>
        <div className="bg-white/10 rounded-xl p-6 sm:p-8 md:p-10 border border-[#393E46]">
          <p className="text-[#e0e0e0] text-sm sm:text-base md:text-lg">Settings page content goes here.</p>
        </div>
      </main>
    </div>
  );
